...
RC FAR PASCAL DetectRegData(PCD pcd, POD pod, CAMF camf, PCAMFD pcamfd, SZ szData);

STATIC_FN RC PRIVATE DRDRcInitializeTrigger(PCD pcd, POD pod);
STATIC_FN RC PRIVATE DRDRcSetDstDirOfTrigger(PCD pcd, POD pod, PCAMFDSetDstDirOfTrigger pcamfd);
STATIC_FN RC PRIVATE DRDRcSetModeOfTrigger(PCD pcd, POD pod, PCAMFDSetModeOfTrigger pcamfd);
...
RC FAR PASCAL DetectRegData(PCD pcd, POD pod, CAMF camf, PCAMFD pcamfd, SZ szData)
{
    ...
    case camfSetDstDirOfTrigger:
        rc = DRDRcSetDstDirOfTrigger(pcd, pod, (PCAMFDSetDstDirOfTrigger)pcamfd);
        break;

    case camfSetModeOfTrigger:
        rc = DRDRcSetModeOfTrigger(pcd, pod, (PCAMFDSetModeOfTrigger)pcamfd);
        break;
